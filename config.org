...
(unicode-fonts-setup)
     ...
     (set-fontset-font "fontset-default" nil (font-spec :size 28 :name "Cascadia Code PL"))
...
** key-binding
   #+BEGIN_SRC emacs-lisp
     ...
     ;;(evil-define-key 'normal 'global (kbd "<leader>r") '(lambda () (interactive) (load-file "~/AppData/Roaming/.emacs.d/init.el")))
