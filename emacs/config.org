...
* org-mode
  #+BEGIN_SRC emacs-lisp
    ...
    (setq org-todo-keyword-faces
	  '(("TODO" . (:foreground "#FFB385" :weight bold :inverse-video t))
	    ("NEXT" . (:foreground "#FF7272" :weight bold :inverse-video t))
	    ("INPROGRESS" . (:foreground "#FFD31D" :weight bold :inverse-video t))
	    ("DONE" . (:foreground "#28FFBF" :weight bold :inverse-video t))
	    ("BLOCKED" . (:foreground "#A19882" :weight bold :inverse-video t))))
