...
** global key-binding
   #+BEGIN_SRC emacs-lisp
     ...
     (global-set-key (kbd "M-o")  'other-window)        ; change quickly between windows, default C-x o
     (global-set-key (kbd "C-c c") (quote compile))      ; compile in buffers directory, usually via 'make'
     ;;(global-set-key (kbd "C-c p") 'replace-string)      ; query for find/replace and replace all
     (global-set-key (kbd "C-x C-b") 'ibuffer)      
     ;;(global-set-key (kbd "C-c C-l") 'auto-fill-mode)      ; toggle whether emacs wraps/newlines text or not
...
** basic configuration and packages setup
  ...
  #+RESULTS:
  | preview-mode-setup | my-latex-mode-setup | turn-on-reftex | latex-extra-mode | flyspell-mode |
** key binding
     #+begin_src emacs-lisp
	 ...
	 (kbd "TAB") nil
	 (kbd "<leader>e") 'LaTeX-environment
	 (kbd "<leader>s") 'LaTeX-section
	 (kbd "<leader>m") 'TeX-insert-macro)
     #+end_src
** reveal.js
